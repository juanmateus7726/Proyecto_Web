<%-- 
    Document   : index
    Created on : 2/05/2025, 9:10:56 a. m.
    Author     : Personal
--%>
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <p>Este sistema permite registrar nuevos usuarios y consultar la informacion de usuario registrados</p>
            <div class="menu">
            ...
            <ul>
                ...
                <li>JSP para renderizar página dinamicas</li>
                <li>Métodos HTTP GET y POST</li>
                <li>Sesiones para almacenas datos</li>
            </ul>
            </p>
        </div>
    </body>
